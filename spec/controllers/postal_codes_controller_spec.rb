...
RSpec.describe PostalCodesController, type: :controller do
  ...
  let(:valid_attributes) { attributes_for(:postal_code) }
  ...
  describe 'when logged in' do
    ...
    describe "GET #show" do
      it "returns a success response" do
        get :show, params: {id: postal_code.code}, session: valid_session
        expect(response).to be_successful
      end
    end
    ...
    describe "POST #search" do
      it "redirects to #show" do
        post :search, params: {code: postal_code.code}, session: valid_session
