...
RSpec.describe ValidationsController, type: :controller do
  ...
  describe 'when logged in' do
    ...
    describe "GET #report" do
      it "returns a success response" do
        get :report, params: {}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe 'JSON requests' do
    ...
    describe "GET #report" do
      it "allows access token via params" do
        get :report, params: {access_key: access_token.key}, session: valid_session, format: :json
        expect(response).to be_successful
      end
      ...
      it "allows access token via params" do
        ...
        get :report, params: {}, session: valid_session, format: :json
        expect(response).to be_successful
      end
    end
  end
